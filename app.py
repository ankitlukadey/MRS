...
def fetch_poster(movie_id):
    response=requests.get("https://api.themoviedb.org/3/movie/{}?api_key=0e4330ae0cbe8563e9a59bac353f54d2&language=en-US".format(movie_id))
    data=response.json()
    return "https://image.tmdb.org/t/p/w500/" +data['poster_path']
def recommend(movie_to_find):
    movie_index=movies[movies['title']==movie_to_find].index[0]
